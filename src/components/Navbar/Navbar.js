...
class Navbar extends Component {
    ...
    render() {
        return(
            <nav>
                <div className="navbar navbar-expand-lg navbar-light bg-primary row">
                    <div className="col-4">
                        <a className="navbar-logo text-light" href="/home">
                            <h1>Newsly</h1>
                        </a>
                    ...
                    <div className="col-4" action="/action_page.php">
                        <form className="input-group my-2 my-lg-2">
                            ...
                            />
                            <button
                                className="btn-search bg-primary text-light p-1"
                                type="submit"><i class="fa fa-search"></i></button>
                        </form>
                    </div>
                    <div className="col-4">
                        <a className="float-right" href="/login">
                            <button type="button" className="btn btn-login text-light p-2">Log In</button>
                        </a>
                        <a className="float-right" href="/signup">
                            <button type="button" className="btn text-light p-2">Sign Up</button>
                        </a>
                    </div>
                </div>
                <div>
